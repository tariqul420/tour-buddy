...
const page = () => {
  return (
    <section className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 bg-white shadow-md rounded-lg py-6 px-6 my-8">
      {/* Left Side - Profile Card */}
      <div className="flex flex-col items-center text-center">
        <div className="relative">
          <Image className="rounded-full object-cover" src={`/tariqul.jpg`} alt="profile" width={120} height={120} />
          <div className='w-8 h-8 flex items-center justify-center rounded-full bg-[#7BBCB0] text-white border border-white absolute bottom-2 right-2 cursor-pointer'>
            <FaPen />
          </div>
        </div>
        <h3 className="text-lg font-semibold mt-4">Tariqul Islam</h3>
        <div className="text-gray-600 flex gap-2 justify-center mt-2">
